 ...
 if(isset($_SESSION['user'])) 
  {
   ...
   ?> <a href="profile"><div id ="log"><img src="<?php $user = R::findOne('users', 'id = ?', array($_SESSION['id'])); echo "http://localhost/POSTPHOTO/". $user->photo; ?>" style="width: 30; heidth:30; vertical-align:middle; border: 2px solid #e24f43"> <?php if(isset($_SESSION['name'])){for () {} echo $_SESSION['name'];} else {echo $_SESSION['login'];} ?></div></a>
