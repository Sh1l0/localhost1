<body>
	<div class="page" style="min-height: 800px;">
		...
		<div style="background-color: #e24f43; padding: 0px;">Популярные гайды
...
<div class="search2"><form>
		<input type="text" name="search2" placeholder="Испарятор 3000"style="box-shadow:  3px 5px 10px grey inset; border: 0px;">
